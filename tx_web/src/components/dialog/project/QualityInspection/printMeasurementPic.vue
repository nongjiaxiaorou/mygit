<template>
    <div style="flex:1;display:flex=1" class="basic1 container">
        <div  ref="print">
            ...
            <div class="text">{{this.$route.params.text1}}</div>
            <div class="text">{{this.$route.params.text2}}</div>
            <div class="picture">   
                <img :src="this.$route.params.PicSrc1" alt="" style="height:500px">
                <img :src="this.$route.params.PicSrc2" alt="" style="height:500px">
            </div>
        </div>
