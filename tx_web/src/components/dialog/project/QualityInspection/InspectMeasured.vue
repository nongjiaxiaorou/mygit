	...
	<div class="basic" style="flex:1;display:flex=1">
		<div class="container" id="userManage1">
			<div class="flex-1 px-5" style="" id="leftBox" >
				<el-tabs :tab-position="tabPosition" v-model="byId" @tab-click="handle"> 
				<el-tree :data="data" :props="defaultProps" @node-click="handleNodeClick" ></el-tree>
                    <div style="margin-left: 0%;width: 95%; margin-height: 10%">
                        <div class="grid-content title-text title-box">质量巡查/</div>
                        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                            ...
                            <!-- 草稿 -->
                            <el-tab-pane label="草稿1" name="first">
...
<script>
	...
	export default {
		...
		methods: {
			...
			// },
			//二级标题
			 handleNodeClick(data,index, row) {
