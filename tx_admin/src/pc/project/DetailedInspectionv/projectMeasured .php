					...
					while ($row = $res -> fetch_assoc()) {
						...
						$res1 = $conn -> query($sql1);
						 while ($row1 = $res1 -> fetch_assoc()) {
							...
							if($status == '初测') {
								if($dataSon[$j]["pointInitialValue"] == '合格') {
									array_push($dataSon1,$dataSon[$j]);
								}
								else {
									array_push($dataSon2,$dataSon[$j]);
								}
							}
							else if ($status == '复测') {
								if($dataSon[$j]["pointRetestValue"] == '合格') {
									array_push($dataSon1,$dataSon[$j]);
								}
								else {
									array_push($dataSon2,$dataSon[$j]);
								...
								if($dataSon[$j]["pointFinaltestValue"]  == '合格') {
									array_push($dataSon1,$dataSon[$j]);
								}
								else {
									array_push($dataSon2,$dataSon[$j]);
						...
						$ret_data['data'][$i]['dataSon1'] = $dataSon1;
						$ret_data['data'][$i]['dataSon2'] = $dataSon2;
