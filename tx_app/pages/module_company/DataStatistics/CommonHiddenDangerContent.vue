...
<script>
	...
	export default {
		...
		methods:{
			...
			//获取重大隐患数据 已选择时间
			getCommonHiddenSelDate() {
				let opts = {
					url: this.api + '/module_company/DataStatistics/RectificationClose.php',
					method: 'POST'
				}
				let param = {
					flag: "getCommonHiddenSelDate",
					company: this.currentData.title,
