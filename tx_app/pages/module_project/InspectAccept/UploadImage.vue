								...
								<view class="uni-uploader__files">
									<block v-for="(image,index) in imageList" :key="index">
										<view class="uni-uploader__file" style="position: relative;">
											...
											<view class="px-1 rounded" style="background-color: rgba(0,0,0,0.5);position: absolute;top: 0;right: 0;"
...
<script>
	...
	export default {
		...
		mounted() {
			this.imageList = this.imageListPar
